...
public class ControllerAllRecipes implements Observer,ControlledScreen{
    ...
    public void update() {
        try {
            model = FXCollections.observableArrayList(service.get_all_recipes());
            reset_pagination();
    ...
    public void load_view(){
        ...
        textField_search.textProperty().addListener((observable, oldValue, newValue) -> {
            try {
                if(newValue!="") {
                    model = FXCollections.observableArrayList(service.get_all_recipes_by_name(textField_search.getText()));
                }else{
                    model = FXCollections.observableArrayList(service.get_all_recipes());
                }
                pagination.setCurrentPageIndex(0);
